...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        print(f'qkv multihead: ',qkv.shape)
...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        print(f'\n input res:{self.input_resolution}  input x shape:{x.shape} shift size:{self.shift_size} \n')
        shortcut = x
        x = self.norm1(x)
        x = x.view(B, H, W, C)
        ...
        print(f'\n %%%%%%%%%%% final attention reshape: {attn_windows.shape} %%%%%%% \n')
        # exit()
        ...
        print(f'after window reverse: {x.shape}')
        x = x.view(B, H * W, C)
    ...
    def forward(self, x):
        for blk in self.blocks:
            if self.use_checkpoint:
                ...
                x = blk(x)
        print(f'downsample exists: {self.downsample}')
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            layer = BasicLayer(dim=int(embed_dim * 2 ** i_layer),
                               ...
                               fused_window_process=fused_window_process)
            #print(f'i:{i_layer} layerr:{layer.__dict__}')
    ...
    def forward_features(self, x):
        ...
        print(f'patch embed out: {x.shape}')
        ...
        print('\n \n $$$$$$$$$$$ Passing Embedded input through SA Layers $$$$$$$$$ \n')
